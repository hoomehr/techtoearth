...
export default function EditCoursePage() {
  ...
  useEffect(() => {
    // Redirect if not admin and not the creator of this course
    if (user && !user.isAdmin && course && course.creatorId !== user.id) {
      ...
      <div className="min-h-screen py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-500">You don't have permission to edit this course.</p>
            <p className="mt-2 text-gray-500">Only admins and the creator of this course can edit it.</p>
            <div className="mt-10">
